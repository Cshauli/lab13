...
enemy1 = drawpad.create_rectangle(50,50,100,75, fill='blue')
enemy2 = drawpad.create_rectangle(100,400,150,425, fill='blue')
enemy3 = drawpad.create_rectangle(150,250,200,275, fill='blue')
class MyApp:
